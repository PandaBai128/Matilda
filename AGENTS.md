...
| `OverlayWindow.swift` | ~975 | Full-screen transparent overlay hosting the Zhuangzhuang portrait, listening waveform, thought dots, bark animation, and configurable target pulse. Handles deterministic cursor following, inactivity hiding, continuous state animation, element pointing with bezier arcs, multi-monitor coordinate mapping, and fade-out transitions. |
